...
<div class="container col-md-5">
		<div class="card">
			<div class="card-body">
			<h1 class="navbar-brand">Delete Participant</h1><br><br>
			...
			<form action="parDelete" method="post">
				...
				<fieldset class="form-group">
                 ...
                 <fieldset class="form-group">
					<label>Name</label> <input type="text" class="form-control" name="name" value="<%=name%>" required="required" readonly>
				</fieldset>
				...
				<input type="submit" class="btn btn-success" name="submit" value="Delete Data" readonly>
